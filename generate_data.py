...
## Data is 48 X 48 --> i converted this into 2304 1D array and have saved it in the csv file along with the labels.

# This generate data class will convert this 1D image back to 2D image and we have read csv file using pandas
class Generate_data():
